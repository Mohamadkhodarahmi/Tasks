...
if ($_GET['pro_id']) {
    ...
    $pro = "SELECT * FROM cart,products where cart.id = products.id";
...
//        header("Location:./");
        ...
        $ssql = "INSERT INTO cart (productname,price,description) select productname,price,description FROM products WHERE {$_GET['pro_id']} = product.id";
